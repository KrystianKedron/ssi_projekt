                ...
                <div class="main-panel">
                    ...
                    <div class="col-xs-6">
                        ...
                        <select name="" id="" class="input-own">
                            ...
                            <option value="10">Marek Nowak</option>
                            <option value="10">Jakub Bukowski</option>
                            <option value="10">Tomasz Komad</option>                            
                        </select>
                    </div>
                    ...
                    <div class="col-xs-12" id="przydzielone-zdania">
                        ...
                        <p>Marek Nowak - <span>Napęd</span> <i class="fa fa-times" aria-hidden="true"></i></p>
                        <p>Tomasz Komad - <span>Stery</span> <i class="fa fa-times" aria-hidden="true"></i></p>
                        <p>Jan Kowalski - <span>Przegląd</span> <i class="fa fa-times" aria-hidden="true"></i></p>
                        <p>Jakub Bukowski - <span>Montaż i regulacja</span> <i class="fa fa-times" aria-hidden="true"></i></p>
                    </div>
